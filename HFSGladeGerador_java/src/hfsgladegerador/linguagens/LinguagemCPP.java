...
public class LinguagemCPP extends Linguagem implements ILinguagem {

	public LinguagemCPP() {
		super(Tipo.CPP, Versao.Gtk2, ".h", ".cpp", "Gtk::", "Glib::ustring", true, true, true, false);
	}
	...
	public String getTipoStore(boolean tab, String idLoja, String tipoLoja,
		...
		if (tab) 
			...
			ret = "";
		ret += "Gtk::TreeModelColumn<" + tipoLoja + "> " + nomeColuna + ";";
	...
	public String getValorColunaStore(boolean tab, boolean bPrimeiro,
		...
		return "\ttLinha[modelo" + objStore + "." + nomeColuna + "] = "+ txt +";" + Rotinas.SEPARADOR_LINHA;
	}
	...
	public String getInicializaConstruirFilho(String ret, boolean tab,
		...
		else if (filho.getClasse().equals(Gtk.GtkTreeViewColumn.toString())) 
		{
			...
			txt = txt.replaceAll("<filhoClasse>", filho.getClasseLinguagem(this) + 
					"("+sTitulo+", Rotinas->modelo"+sModelo+".coluna"+filho.getOrdemTreeViewColumn()+")"); 				
		}
	...
	public String propriedadeObjetoValor(Objeto filho, Propriedade prop, String nome) {
		...
		if (prop.getNome().equals(nome)){
			txt = Rotinas.getRecurso("PropriedadeFilho", nome, Tipo.CPP);
	...
	public String getInicializaAddFilhoAoPai(String ret, boolean tab,
		...
		String txt = "";
		txt = Rotinas.getRecurso("InicializaAddFilhoAoPai", Tipo.CPP);
	...
	public String getInicializaAddFilhoAoFormulario(String ret, boolean tab,
		...
		if (bDialogClasse){
			txt = txt.replaceAll("<contentArea>","get_vbox()->");
		} else {
	...
	public String getStoreAddValores(String ret, boolean tab, String objStore,
		...
		if (!tab) {
			txt = txt.replaceAll("<variaveis>", "Gtk::TreeIter iter;"+Rotinas.SEPARADOR_LINHA+
					"\tGtk::TreeRow tLinha;"+Rotinas.SEPARADOR_LINHA+Rotinas.SEPARADOR_LINHA);			
		} else {
